...
class DirectionContainer extends Component {
  ...
  componentDidMount() {
    ...
    fetchQuestions({ questionType: 'direction' });
  }

  onFinish = data => {
    console.log('🚀 ~ file: index.js ~ line 62 ~ DirectionContainer ~ data', data);
  }

  sendDataToServer = (sender) => {
    const resultAsString = JSON.stringify(sender.data);
    console.log('🚀 ~ file: index.js ~ line 50 ~ DirectionContainer ~ resultAsString', resultAsString);
  }
